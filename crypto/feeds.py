...
def rssfeed_generator(jsonfilename_for_converting, customize_feedname, feeds_link, rss_description):#translate json to XML for rss
    ...
    #rss_xml4 = ET.fromstring(rss_xml3)
    #rss_xml = rss_xml4
    #rss_xml = ET.fromstring(unescape(ElementTree.tostring(rss_xml, encoding='utf8', method='xml').decode()))

    #vyrde_xml = ET.ElementTree(rss_xml)
    return rss_xml3
